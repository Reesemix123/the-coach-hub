# Titan First Read - Production Deployment Plan
...
3. **Add Production URL to Allowed Origins:**
   ...
   - Add Site URL: `https://titan-first-read.vercel.app` (or your custom domain)
   - Add Redirect URL: `https://titan-first-read.vercel.app/auth/callback`
...
1. **Create New Project:**
   ...
   - Name: "titan-first-read-production"
...
3. **Import Project:**
   - "Add New..." → Project
   - Select your GitHub repository: `titan-first-read`
   - Click "Import"
...
3. You'll get a URL: `https://titan-first-read.vercel.app`
...
If you own a domain (e.g., titanfirstread.com):
...
Live site: https://titan-first-read.vercel.app
