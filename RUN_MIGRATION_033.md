...
2. Open this file on your computer:
   ```
   /Users/markreese/titan-first-read/supabase/migrations/033_add_multi_player_defensive_tracking.sql
   ```
...
```
/Users/markreese/titan-first-read/CHECK_PARTICIPATION_DATA.sql
```
