...
description: Learn how to add players, manage your depth chart, and organize your roster in Youth Coach Hub.
order: 2
---
...
|-------|-------------|----------|
| **Jersey Number** | Player's number | Yes |
| **First Name** | Player's first name | Yes |
| **Last Name** | Player's last name | Yes |
| **Position(s)** | Primary and secondary positions | Yes |
| **Grade Level** | 6th Grade through Senior | No |
| **Notes** | Any additional information | No |

3. Set depth chart positions (optional)
4. Click **Save**
