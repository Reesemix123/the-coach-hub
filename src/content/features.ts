  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Coaches invite parents via email to join the team communication hub',
      ...
      },
      {
        ...
        description: 'Seasonal billing for the parent communication hub with tiered pricing',
        guidePath: '/guide/communication/plans',
        navigationPath: 'Communication > Plan (coach)',
        subFeatures: [
          'Rookie ($149/season): up to 20 parents, 10 team videos',
          'Varsity ($249/season): up to 40 parents, 10 team videos',
          'All-Conference ($349/season): up to 60 parents, 10 team videos',
          'All-State ($449/season): unlimited parents, 10 team videos',
          'All plans: unlimited individual clips, SMS + email, RSVP, reports',
          '6-month season duration with 30-day grace period',
          'Video top-up packs: 5 for $39',
        ],
      },
      {
