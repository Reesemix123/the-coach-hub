  ...
  if (!gameId) {
    ...
    return (
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-8">
          <Link
            href={`/football/teams/${teamId}/game-week`}
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-8">
          ...
          <div className="space-y-3">
            {upcomingGames?.map((game: any) => (
              <Link
                key={game.id}
                href={`/football/teams/${teamId}/strategy-assistant?game=${game.id}`}
            ...
            {(!upcomingGames || upcomingGames.length === 0) && (
              <div className="text-center py-8 text-gray-500">
                ...
                <Link href={`/football/teams/${teamId}/schedule`} className="text-gray-900 underline">
                  Add a game
                </Link>
              </div>
            )}
        ...
        <div className="space-y-6">
          ...
          <section className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              ...
              <Link
                href={`/football/teams/${teamId}/strategy-assistant/questions?game=${gameId}`}
          ...
          <section className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              ...
              <Link
                href={`/football/teams/${teamId}/strategy-assistant/checklist?game=${gameId}`}
