...
export default function TeamPlaybookPage({ params }: { params: Promise<{ teamId: string }> }) {
  ...
  function handlePrintWristband() {
    ...
    router.push(`/football/teams/${teamId}/playbook/print-wristband/${activeGamePlan.id}`);
  }

  function handlePrintCoachSheet() {
    if (!activeGamePlan) return;
    router.push(`/football/teams/${teamId}/playbook/print-coach-sheet/${activeGamePlan.id}`);
  }
        ...
        <div className="flex items-start justify-between mb-8">
          <div className="flex-1">
            ...
            <div className="mt-4 flex items-center gap-3">
              <button
                onClick={() => router.push(`/football/teams/${teamId}/playbook/new`)}
                    ...
                    {filteredPlays.map(play => (
                      ...
                      >
                        ...
                        <div className="p-3 bg-gray-50 flex items-center justify-between">
                          <button
                            onClick={() => router.push(`/football/teams/${teamId}/playbook/${play.id}`)}
