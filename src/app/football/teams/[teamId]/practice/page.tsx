      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex flex-col items-end gap-3">
            <div className="flex items-center gap-3">
              <AIPracticeAssistButton
                ...
                onPlanCreated={(planId) => {
                  router.push(`/football/teams/${teamId}/practice/${planId}/edit`);
                }}
              />
              <button
                onClick={() => router.push(`/football/teams/${teamId}/practice/new`)}
            ...
            <button
              onClick={() => router.push(`/football/teams/${teamId}/practice/new?template=true`)}
              ...
              >
                <div className="p-6">
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    <div className="flex items-center gap-2 mb-2">
                      <button
                        onClick={() => router.push(`/football/teams/${teamId}/practice/${practice.id}`)}
                        className="flex-1 px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors text-sm font-medium"
                      >
                        View Plan
                      </button>
                      <button
                        onClick={() => router.push(`/football/teams/${teamId}/practice/${practice.id}/edit`)}
