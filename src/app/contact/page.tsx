        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 bg-[#161b22] border border-gray-800 rounded-xl">
                <div className="w-10 h-10 bg-[#a3e635]/10 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            {status === 'success' ? (
              <div className="text-center py-8">
                ...
                <button
                  ...
                  className="text-[#a3e635] hover:text-[#bef264] transition-colors font-medium"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-[#0d1117] border border-gray-700 rounded-lg text-white focus:border-[#a3e635] focus:ring-1 focus:ring-[#a3e635] focus:outline-none transition-colors"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-[#0d1117] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:border-[#a3e635] focus:ring-1 focus:ring-[#a3e635] focus:outline-none transition-colors resize-none"
