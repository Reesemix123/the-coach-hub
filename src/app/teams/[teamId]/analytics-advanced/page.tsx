          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-yellow-700 mb-3">
                We've built a new unified reporting system with enhanced features and better organization.
                This page will be deprecated in a future update.
              </p>
              <button
                onClick={() => router.push(`/teams/${teamId}/analytics-reporting`)}
                className="px-4 py-2 bg-yellow-600 text-white text-sm font-medium rounded-lg hover:bg-yellow-700 transition-colors"
              >
                Try the New Analytics and Reporting →
              </button>
            </div>
          </div>
        </div>
