...
export default function AllRBStatsSection({ teamId, gameId }: AllRBStatsSectionProps) {
    ...
    return (
      <section className="mb-12">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center">
          <p className="text-blue-800 text-lg mb-2">No RB data available</p>
          <p className="text-blue-700 text-sm">
            RB stats will appear once you tag plays with RB as ball carrier or target (Tier 2+ feature).
          </p>
        </div>
      </section>
    );
