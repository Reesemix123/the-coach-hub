...
export default function AllDBStatsSection({ teamId, gameId }: AllDBStatsSectionProps) {
    ...
    return (
      <section className="mb-12">
        ...
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-8 text-center">
          <p className="text-purple-800 text-lg mb-2">No DB data available</p>
          <p className="text-purple-700 text-sm">
            DB stats will appear once you tag defensive plays with DB participation (Tier 3 feature).
          </p>
        </div>
      </section>
    );
