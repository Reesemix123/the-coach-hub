...
export default function OpponentScoutingReport({ teamId, filters }: ReportProps) {
  ...
  return (
    <div>
      {/* Opponent Selector - matches ReportFilters styling */}
      <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
        <div>
          ...
          <select
            ...
            className="w-full sm:w-auto sm:min-w-80 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 text-gray-900"
          >
