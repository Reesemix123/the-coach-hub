// src/components/playbuilder/LinebackersSection.tsx
'use client';
...
interface LinebackersSectionProps {
  players: Player[];
...
export function LinebackersSection({
  players,
  onUpdateRole,
  onUpdateBlitz,
  onResetToRole
}: LinebackersSectionProps) {
  ...
  return (
    <div className="border border-gray-200 rounded-lg overflow-hidden">
      ...
      >
        <h4 className="font-semibold text-gray-900">Linebackers ({players.length})</h4>
        <svg
